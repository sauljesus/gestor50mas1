  ...
  ***********************************************/
  ...
  const crearTaller = (e) => {
    ...
    axios.post(`${getdireccion()}/tallercreate`, taller).then((res) => {
      ...
      setMessage(res.data.msg);
      setShowNotification(true);
      document.getElementById("crear-taller").reset();
      setTimeout(() => {
        // setShowNotification(false);
        // window.location.reload();
      }, 5000);
              ...
              <div className={showAlumno ? "ing-content-form" : "ing-display-n"}>
                ...
                <div className='f-block'>
                  <form id="crear-alumno" className='f-cont-form-reg' onSubmit={crearAlumno} >
                    ...
                    <input required maxLength={45} className='f-log-input' type="text" name="txtNombre" placeholder="Nombre" />
                    <h1 className='f-log-semititu'>Apellido Paterno</h1>
                    <input required maxLength={30} className='f-log-input' type="text" name="txtApellidoPaterno" placeholder="Apellido Paterno" />
                    <h1 className='f-log-semititu'>Apellido Materno</h1>
                    <input required maxLength={30} className='f-log-input' type="text" name="txtApellidoMaterno" placeholder="Apellido Materno" />
                    <h1 className='f-log-semititu' >CURP</h1>
                    <input required maxLength={18} className='f-log-input' type="text" name="txtCurp" placeholder="CURP" onkeyup="this.value = this.value.toUpperCase();" />
                    <h1 className='f-log-semititu'>RFC</h1>
                    <input required maxLength={13} className='f-log-input' type="text" name="txtrfc" placeholder="RFC" />
                    ...
                    <input required maxLength={45} className='f-log-input' type="text" name="txtCalle" placeholder="Calle" />
                    <h1 className='f-log-semititu'>Número</h1>
                    <input required maxLength={10} className='f-log-input' type="text" name="txtNum" placeholder="Número" />
                    <h1 className='f-log-semititu'>Colonia</h1>
                    <input required maxLength={40} className='f-log-input' type="text" name="txtColonia" placeholder="Colonia" />
                    <h1 className='f-log-semititu'>Municipio</h1>
                    <input required maxLength={30} className='f-log-input' type="text" name="txtMunicipio" placeholder="Municipio" />
                    <h1 className='f-log-semititu'>Estado</h1>
                    <input required maxLength={30} className='f-log-input' type="text" name="txtEstado" placeholder="Estado" />
                    <h1 className='f-log-semititu'>Código Postal</h1>
                    <input required maxLength={6} className='f-log-input' type="number" name="txtCp" placeholder="Código Postal" />
                    <h1 className='f-log-semititu'>Teléfono</h1>
                    <input required maxLength={13} className='f-log-input' type="text" name="txtTelefono" placeholder="Teléfono" />
                    <h1 className='f-log-semititu'>Celular</h1>
                    <input required maxLength={13} className='f-log-input' type="text" name="txtCelular" placeholder="Celular" />
                    <h1 className='f-log-semititu'>Correo</h1>
                    <input required maxLength={50} className='f-log-input' type="email" name="txtCorreo" placeholder="Correo" />
                    <h1 className='f-log-semititu'>Contraseña</h1>
                    <input required className='f-log-input' type="password" name="txtPass" placeholder="Contraseña" />
                    <h1 className='f-log-semititu'>Confirmar Contraseña</h1>
                    <input required className='f-log-input' type="password" name="txtConfpass" placeholder="Contraseña" />
                    <h1 className='f-log-semititu'>Edad</h1>
                    <input required maxLength={3} className='f-log-input' type="number" name="txtEdad" placeholder="Edad" />
                    <h1 className='f-log-semititu'>Nivel Académico</h1>
                    <input required maxLength={30} className='f-log-input' type="text" name="txtNivelAcademico" placeholder="Nivel Académico" />
                    ...
                    <input required maxLength={50} className='f-log-input' type="text" name="txtNivelAHijos" placeholder="Nivel Académico Hijos" />
                    ...
                    <input required maxLength={50} className='f-log-input' type="text" name="txtEmpresa" placeholder="Empresa" />
                    <h1 className='f-log-semititu'>Dirección Empresa</h1>
                    <input required maxLength={50} className='f-log-input' type="text" name="txtdireccionEmpresa" placeholder="Dirección Empresa" />
                    <h1 className='f-log-semititu'>Registro Medico</h1>
                    <input required maxLength={50} className='f-log-input' type="text" name="txtregistroMedico" placeholder="Registro Medico" />
              ...
              <div className={showTaller ? "ing-content-form" : "ing-display-n"}>
                ...
                <div className='f-block'>
                  <form id="crear-taller" className='f-cont-form-reg' onSubmit={crearTaller} >
                    ...
                    <input className='f-log-input' maxLength="50" type="email" name="txtcorreoTaller" />
                    <h1 className='f-log-semititu'>Nombre</h1>
                    <input required className='f-log-input' maxLength="50" type="text" name="txtnombreTaller" />
                    ...
                    <input required className='f-log-input' maxLength="20" type="text" name="txtperiodoTaller" />
                    <button className='f-log-boton-formi'>Registrar</button>
                  </form>
                </div>
              </div>
              <div className={showProfesor ? "ing-content-form" : "ing-display-n"}>
                ...
                <div className='f-block'>
                  <form id="crear-usuario" className='f-cont-form-reg' onSubmit={crearUsuario} >
                    ...
                    <input required className='f-log-input' maxLength="30" type="text" name="txtnombreU" placeholder="" />
                    <h1 className='f-log-semititu'>Apellido Paterno</h1>
                    <input required className='f-log-input' maxLength="30" type="text" name="txtapPaternoU" placeholder="" />
                    <h1 className='f-log-semititu'>Apellido Materno</h1>
                    <input required className='f-log-input' maxLength="30" type="text" name="txtapMaternoU" placeholder="" />
                    <h1 className='f-log-semititu'>Email</h1>
                    <input required className='f-log-input' maxLength="30" type="email" name="txtEmailU" placeholder="" />
                    <h1 className='f-log-semititu'>password</h1>
                    <input required className='f-log-input' maxLength="30" type="password" name="txtpassU" placeholder="" />
                    <h1 className='f-log-semititu'>confirmar password</h1>
                    <input required className='f-log-input' maxLength="30" type="password" name="txtconfpassU" placeholder="" />
